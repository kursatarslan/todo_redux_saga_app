export const taskActions = {
  ...
  GET_ALL_TASKS_FAILED: 'CREATE_TASK_FAILED',
  ...
  signInFulfilled: () => ({
    type: taskActions.SIGN_IN_FULFILLED
  }),
  ...
  createTask: (title, description) => ({
    ...
    payload: {task: {title, description, completed: false}}
  }),
  ...
  getAllTasksFailed: () => ({
    type: taskActions.GET_ALL_TASKS_FAILED
  }),
